...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Wet Hub Notification", 
        Text = tostring(value),
        Icon = "http://www.roblox.com/asset/?id=12838026403",
        Duration = 10
    })
end
function Com()
    game.StarterGui:SetCore("SendNotification", {
        Title = "WET Notification", 
        Text = "✅  Complete",
        Icon = "http://www.roblox.com/asset/?id=12838026403",
        Duration = 5
    })
	...
	function CheckLevel2()
		...
		if Three_World and not Auto_Raid then
			...
			elseif MyLevel >= 2275 and  MyLevel <= 2300 then
				...
				TelePBoss(CFrameQ)
			elseif MyLevel >= 2300 and MyLevel <= 2325 then 
				Ms = "Cocoa Warrior [Lv. 2300]"
				NameQuest = "ChocolateQuest1"
				LevelQuest = 1
				NameMon = "Cocoa Warrior"
				CFrameQuest = CFrame.new(231.75, 23.9003029, -12200.292, -1, 0, 0, 0, 1, 0, 0, 0, -1)
				CFrameMon = CFrame.new(50.71434783935547, 54.8857421875, -12309.982421875)
				TelePBoss(CFrameQ)
			elseif MyLevel >= 2325 and MyLevel <= 2350 then 
				Ms = "Chocolate Bar Battler [Lv. 2325]"
				NameQuest = "ChocolateQuest1"
				LevelQuest = 2
				NameMon = "Chocolate Bar Battler"
				CFrameQuest = CFrame.new(231.75, 23.9003029, -12200.292, -1, 0, 0, 0, 1, 0, 0, 0, -1)
				CFrameMon = CFrame.new(719.6550903320312, 66.3912582397461, -12601.0322265625)
				TelePBoss(CFrameQ)
			elseif MyLevel >= 2350 and MyLevel <= 2375 then 
				...
				CFrameMon = CFrame.new(-6.758682727813721, 78.16036987304688, -12552.494140625)
				TelePBoss(CFrameQ)
			elseif MyLevel >= 2375 and MyLevel <= 2400 then 
				...
				NameMon = "Candy Rebel"
				CFrameQuest = CFrame.new(151.198242, 23.8907146, -12774.6172, 0.422592998, 0, 0.906319618, 0, 1, 0, -0.906319618, 0, 0.422592998)
				CFrameMon = CFrame.new(26.954172134399414, 102.24951171875, -12923.33984375)
				TelePBoss(CFrameQ)
			elseif MyLevel >= 2400 and MyLevel <= 2425 then 
				...
				CFrameMon = CFrame.new(-1246.1024169921875, 14.10724925994873, -14506.6162109375)
				TelePBoss(CFrameQ)
			elseif MyLevel >= 2425 and MyLevel <= 2450 then 
				...
				NameMon = "Snow Demon"
				CFrameQuest = CFrame.new(-1149.328, 13.5759039, -14445.6143, -0.156446099, 0, -0.987686574, 0, 1, 0, 0.987686574, 0, -0.156446099)
				CFrameMon = CFrame.new(-924.6251220703125, 14.107307434082031, -14543.234375)
				TelePBoss(CFrameQ)
			end
		end
	end
		...
		if setclipboard and daaata[8] then
			...
			if common_table then
				common_table[1 + #common_table] = {
					Name = "Join Discord",
					Callback = function()
						setclipboard("https://discord.gg/v9fbCqt2")
					end
				}
				common_table = nil
			end
...
local WETui = library:CreateWindow({
    Name = "Wet Hub Premium",
    Theme = {
...
local General_Tab = WETui:CreateTab({
	Name = "General"
})
local Quest_Tab = WETui:CreateTab({
	Name = "mics"
})
local Raid_Tab = WETui:CreateTab({
	Name = "Raid"
})
local Island_Tab = WETui:CreateTab({
	Name = "Island"
})
local Shop_Tab = WETui:CreateTab({
	Name = "Shop"
})
local Status_Tab = WETui:CreateTab({
	Name = "Status"
})
local PvP_Tab = WETui:CreateTab({
	Name = "PVP"
})
local Setting_Tab = WETui:CreateTab({
	Name = "Setting"
})
local FarmingSection = General_Tab:CreateSection({
	Name = "Auto Farm"
})
...
FarmingSection:AddToggle({
    Name = "Fast Attack",
	Value = _G.Setting_table.FastAttack, -- ปรับค่าToggle true/false or Config
    Callback = function(vu)
...
local Select_W = FarmingSection:AddDropdown({
	Name = "Select Weapon",
	flag = "",
	Value = _G.Setting_table.Weapon,
	List = Waspon,function(vu)
...
FarmingSection:AddButton({
	Name = "Refresh Weapon",
	callback = function(vu)
	Select_W:ItemsCleared()
	for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
		if v:IsA("Tool") then
			Select_W:ItemAdded(v.Name)
		end
	end
	for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do  
		if v:IsA("Tool") then
...
FarmingSection:AddLabel("Farm Boss")
FarmingSection:Toggle({
	Name = "Auto Farm",
	Value = _G.Setting_table.Farm_Boss,
	Callback = function(vu)
		Auto_Farm_Boss = vu
...
FarmingSection:AddToggle({
	...
	Value = _G.Setting_table.Farm_All_Boss,
	Callback = function(vu)
...
local Select_B = FarmingSection:AddDropdown({
	Name = "Select Boss",
	Value = _G.Setting_table.Boss_Name,
	List = Boss,
	Callback = function(vu)
		_G.Setting_table.Boss_Name = vu
end
})
local Select_BK = FarmingSection:AddDropdown({
	Name = "Select Lock Boss",
	Value = _G.Setting_table.Boss_Lock,
	List = Boss_List,
	Callback = function(vu)
...
FarmingSection:AddLabel("Farm Monster")
FarmingSection:AddToggle({
	Name = "Auto Farm",
	Value = _G.Setting_table.Auto_Farm_Monster,
	Callback = function(vu)
...
local Select_M = FarmingSection:AddDropdown({
	Name = "Select Monster",
	Value = _G.Setting_table.Mon_Name,
	List = Mons,
	Callback = function(vu)
...
local MasterySection = General_Tab:CreateSection({
	Name = "Mastery",
	Side = "Right"
})
MasterySection:AddLabel("Farm Mastery")
MasterySection:AddToggle({
	Name = "Auto Farm Fruit",
	Value = _G.Setting_table.Farm_Fruit,
	Callback = function(vu)
		Auto_Farm_Fruit = vu
...
MasterySection:AddSlider({
	...
	Min = 1,
	Max = 30,
	Value = _G.Setting_table.MinHealth,
	Callback = function(vu)
		MinHealth = vu
...
MasterySection:AddToggle({
	Name = "Auto Farm Gun",
	Value = _G.Setting_table.Farm_Gun,
	Callback = function(vu)
		Auto_Farm_Gun = vu
...
MasterySection:AddToggle({
	Name = "Skill Z",
	Value = _G.Setting_table.Skill_Z,
	Callback = function(vu)
		SkillZ = vu
...
MasterySection:AddToggle({
	Name = "Skill X",
	Value = _G.Setting_table.Skill_X,
	Callback = function(vu)
		SkillX = vu
		_G.Setting_table.Skill_Z = vu
end
...
MasterySection:AddToggle({
	Name = "Skill C",
	Value = _G.Setting_table.Skill_C,
	Callback = function(vu)
		SkillC = vu
		_G.Setting_table.Skill_Z = vu
end
...
MasterySection:AddToggle({
	Name = "Skill V",
	Value = _G.Setting_table.Skill_V,
	Callback = function(vu)
		SkillV = vu
		_G.Setting_table.Skill_Z = vu
end
...
MasterySection:AddToggle({
	...
	Value = _G.Setting_table.Farm_Melee,
	Callback = function(vu)
		Auto_Farm_Melee = vu
...
MasterySection:AddToggle({
	...
	Value =  _G.Setting_table.Farm_Sword,
	Callback = function(vu)
		Auto_Farm_Sword = vu
...
MasterySection:AddLabel('Farm Bone')
MasterySection:AddToggle({
	Name = "Auto Farm Bone",
	Value = _G.Setting_table.Farm_Bone,
	Callback = function(vu)
		Auto_Farm_Bone = vu
...
MasterySection:AddButton({
	Name = "Auto Buy Random Surprise",
	Value = _G.Setting_table.Farm_Random_S,
	Callback = function(vu)
		Farm_Random_S = vu
...
MasterySection:AddLabel('Farm Observation Haki')
MasterySection:AddToggle({
	Name = " Farm Observation Haki",
	Value = _G.Setting_table.Farm_Ken,
	Callback = function(vu)
		Farm_Ken = vu
...
MasterySection:Label("Farm Object")
MasterySection:Toggle({
	Name = "Auto Open Color Haki",
	Value = _G.Setting_table.Farm_Ob_Color,
	Callback = function(vu)
		Open_Color_Haki = vu
...
MasterySection:AddToggle({
	...
	Value = _G.Setting_table.Auto_Holy_Torch,
	Callback = function(vu)
		Auto_Holy_Torch = vu
...
MasterySection:Toggle({
	...
	Value = _G.Setting_table.Grab_Chest,
	Callback = function(vu)
		Grab_Chest = vu
...
MasterySection:AddSlider({
	...
	Min = 1,
	Max = 100,
	Value = _G.Setting_table.K_MAX,
	Callback = function(vu)
		_G.Setting_table.K_MAX = vu
end
})
local K_C = MasterySection:AddLabel('Chest Lock : 0')
...
MasterySection:AddLabel("Farm Stats")
MasterySection:AddToggle({
	Name = "Melee",
	Value = _G.Setting_table.Melee_A,
	Callback = function(vu)
		Melee_A = vu
...
MasterySection:AddToggle({
	Name = "Defense",
	Value = _G.Setting_table.Defense_A,
	Callback = function(vu)
		Defense_A = vu
...
MasterySection:AddToggle({
	Name = "Sword",
	Value = _G.Setting_table.Sword_A,
	Callback = function(vu)
		Sword_A = vu
...
MasterySection:AddToggle({
	Name = "Fruit",
	Value = _G.Setting_table.Fruit_A,
	Callback = function(vu)
		Fruit_A = vu
