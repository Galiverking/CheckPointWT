...
local getserver = requesthttps({
    ["Url"] = "http://:192.168.56.1/whitelist?Key="..Key.."&ds="..discord_id, -- ใส่ Ip
    ["Medthod"] = "GET"
})
...
local gethwid = requesthttps({
    ["Url"] = "http://:192.168.56.1/Hwid", -- ใส่ Ip
})
wait(1)
...
if getserver.StatusCode == 200 and gethwid.StatusCode == 200 then
    ...
    if getdata ~= "Invalid Key" then
        if getdata ~= "Invalid Discord Id" then
            if string.find(getdata,"You got blacklisted reason") then
                ...
                if getdata ~= "Invalid HWID" then
                    ...
                    game.StarterGui:SetCore("SendNotification", {
                        ...
                        Icon = "http://www.roblox.com/asset/?id=12554750564", -- LOGO
                        Duration = 2.5
                    })
                    ...
                    ImageLabel.Image = "rbxassetid://12554750564" -- LOGO
            ...
            wait(math.random(1, 2))
            print("[Wet-Hub] : Loading.. (1/3)")
            wait(math.random(1, 3))
            print("[Wet-Hub] : Authenticated (2/3)")
            wait(math.random(1, 4))
            ntf("\nCorrect Discord ID")
            print("[Wet-Hub] : Correct Discord ID (3/3)")
            print("[Wet-Hub] : " .. getdata)
        end
    else
        wait(math.random(1, 2))
        print("[Wet-Hub] : Loading.. (1/3)")
